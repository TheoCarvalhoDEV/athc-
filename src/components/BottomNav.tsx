...
export const BottomNav = () => {
  ...
  return (
    <div className="fixed bottom-6 left-0 right-0 flex justify-center z-[9999] px-4 transform translate-y-0 will-change-transform md:hidden" style={{ transform: 'translate3d(0, 0, 0)', backfaceVisibility: 'hidden' }}>
