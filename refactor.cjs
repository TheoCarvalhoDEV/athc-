...
content = content.replace(
  /value=\{formData\.title\}\n\s*onChange=\{e => setFormData\(\{ \.\.\.formData, title: e\.target\.value \}\)\}/g,
  `{...register('title')}`
);
content = content.replace(
  /value=\{formData\.date\}\n\s*onChange=\{e => setFormData\(\{ \.\.\.formData, date: e\.target\.value \}\)\}/g,
  `{...register('date')}`
);
content = content.replace(
  /value=\{formData\.time\}\n\s*onChange=\{e => setFormData\(\{ \.\.\.formData, time: e\.target\.value \}\)\}/g,
  `{...register('time')}`
);
content = content.replace(
  /value=\{formData\.location\}\n\s*onChange=\{e => setFormData\(\{ \.\.\.formData, location: e\.target\.value \}\)\}/g,
  `{...register('location')}`
);
content = content.replace(
  /value=\{formData\.address\}\n\s*onChange=\{e => setFormData\(\{ \.\.\.formData, address: e\.target\.value \}\)\}/g,
  `{...register('address')}`
);
content = content.replace(
  /value=\{formData\.publicType\}\n\s*onChange=\{e => setFormData\(\{ \.\.\.formData, publicType: e\.target\.value \}\)\}/g,
  `{...register('publicType')}`
);
content = content.replace(
  /value=\{formData\.description\}\n\s*onChange=\{e => setFormData\(\{ \.\.\.formData, description: e\.target\.value \}\)\}/g,
  `{...register('description')}`
);
content = content.replace(
  /value=\{formData\.whatsappNumber\}\n\s*onChange=\{e => setFormData\(prev => \(\{ \.\.\.prev, whatsappNumber: e\.target\.value \}\)\)\}/g,
  `{...register('whatsappNumber')}`
);
content = content.replace(
  /onClick=\{\(\) => setFormData\(prev => \(\{ \.\.\.prev, hasTickets: !prev\.hasTickets \}\)\)\}/g,
